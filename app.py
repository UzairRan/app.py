...
def fetch_announcements(ticker):
    encoded_ticker = quote(ticker)  # Encode the ticker symbol
    url = f'https://www.asx.com.au/asx/1/company/{encoded_ticker}/announcements?count=20&market_sensitive=false'
    headers = {
